...
import { Play, Trophy, Filter, Shuffle } from "lucide-react"
...
export default function RandomResultsPage() {
  ...
  useEffect(() => {
    const loadResults = async () => {
      ...
      const res = await fetch(`/api/admin/results/random`, {
      ...
      <SidebarInset>
        <header className="flex h-14 shrink-0 items-center gap-2 border-b px-4">
          ...
          <div className="flex items-center gap-2">
            ...
            <h1 className="text-lg font-semibold">Random Game Results</h1>
          </div>
        </header>
